<div class="page-wrapper">
    <div class="grid md:grid-cols-2 gap-6">
        <div class="card card-divider h-fit">
            <div class="card-body">
                <input type="search" class="input input-bordered" placeholder="Cari menu"
        ...
        <div class="card h-fit">
            <form class="card-body space-y-4" wire:submit="simpan">
                ...
                <textarea rows="3" class="textarea textarea-bordered"
                    placeholder="Keterangan transaksi, bisa diisi dengan nomor meja" wire:model="form.desc"></textarea>
