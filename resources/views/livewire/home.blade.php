        ...
        <div class="card card-compact">
            <div class="card-body flex-row items-center gap-3">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="font-2xl font-bold">Rp. {{ Number::format($monthly) }}</div>
                </div>
            </div>
        </div>
        <div class="card card-compact">
            <div class="card-body flex-row items-center gap-3">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="font-2xl font-bold">Rp. {{ Number::format($today->sum('price')) }}</div>
                </div>
            </div>
        </div>
        <div class="card card-compact">
            <div class="card-body flex-row items-center gap-3">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="font-2xl font-bold">{{ $today->count() }} Pesanan</div>
                </div>
            </div>
        </div>
    </div>
